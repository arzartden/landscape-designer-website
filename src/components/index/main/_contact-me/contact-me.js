...
const successfullSending = 'Ваши данные успешно отправлены.';
const notSuccessfullSending = `Ошибка отправки данных. Попробуйте снова <br>
...
form.addEventListener('submit', (e) => {
  ...
  message => {
    if (message === 'OK') {
      modalText.innerHTML = successfullSending;
      modal.classList.toggle('show-modal');
    } else {
      modalText.innerHTML = notSuccessfullSending;
      modal.classList.toggle('show-modal');
    }
  }
  );
